...
var products =
  [
    ...
    new Product({
      _id: "62f8fa33541a463690a68ef8",
      imagePath: 'https://i.imgur.com/f1NBBrV.jpeg',
      title: 'CHINA DRESS',
      description: 'China dress wear by long hair girl with beautiful. Best sale in 2022 must haveeee',
      price: 45.90,
      color: 'RED ',
      size: 'XS',
      quantity: 23,
    ...
    new Product({
      _id: "62f8fa33541a463690a68ef9",
      imagePath: 'https://i.imgur.com/gMByL8V.jpeg',
      title: 'BUNNY DRESS',
      description: 'Bunny dress wear by long hair girl with beautiful. Best sale in 2022 must haveeee',
      price: 45.90,
      color: 'PINK ',
      size: 'XS',
      quantity: 23,
    ...
    new Product({
      _id: "62f8fbe8672cb71e8811f779",
      imagePath: 'https://i.imgur.com/l8lOpPG.jpg',
      title: 'BLUE SHIRT',
      description: 'Blue shirt wear by hansome boy with beautiful. Best sale in 2022 must haveeee',
      price: 45.90,
      color: 'BLUE ',
      size: 'XS',
      quantity: 23,
...
var variants =
  [
    ...
    new Variant({
      productID: "5bedf7ecc14d7822b39d9d55",
      imagePath: 'https://static.zara.net/photos///2018/I/0/2/p/3548/350/700/2/c-192-0-2048-3072/w/1920/3548350700_2_1_1.jpg?ts=1528819649601',
      color: 'DEFAULT',
      size: 'M,XL',
      quantity: 5,
    ...
    new Variant({
      productID: "62f63fd2149ef4213075ea24",
      imagePath: 'https://static.zara.net/photos///2020/I/0/3/p/3183/700/800/2/w/560/3183700800_1_1_1.jpg?ts=1597336424462',
      color: 'DEFAULT',
      size: 'M,XL',
      quantity: 5,
    ...
    new Variant({
      productID: "62f8fa33541a463690a68ef8",
      imagePath: 'https://i.imgur.com/f1NBBrV.jpeg',
      color: 'DEFAULT',
      size: 'M,XL',
      quantity: 5,
    ...
    new Variant({
      productID: "62f8fa33541a463690a68ef9",
      imagePath: 'https://i.imgur.com/gMByL8V.jpeg',
      color: 'DEFAULT',
      size: 'M,XL',
      quantity: 5,
    ...
    new Variant({
      productID: "62f8fbe8672cb71e8811f779",
      imagePath: 'https://i.imgur.com/l8lOpPG.jpg',
      color: 'DEFAULT',
      size: 'M,XL',
      quantity: 5,
